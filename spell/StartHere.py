...
if (int(light) >= 9):
    ...
    lightDmg = 0
playerDmg = fireDmg+waterDmg+earthDmg+airDmg+darkDmg+lightDmg
playerLvl = 1
playerXp = 0
nextXp = 100
...
def battle():
    ...
    while enemyHp > 0:
        ...
        if battle == "attack":
            ...
            print ("The orc lashes out in anger")
        ...
        if battle == "block":
            ...
            print ("With the orc leaving itself open you hit it in retaliation")
